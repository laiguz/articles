<div>
    <section class="p-6 dark:bg-gray-800 dark:text-gray-50">
        <form wire:submit="update()" class="container flex flex-col mx-auto space-y-12">
            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                ...
                <div class="col-span-full">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        @if ($thumbnail)
                            <div>
                                <img src="{{ url('storage/articles/' . $model_id . '/' . $thumbnail . '.webp') }}"
                                    wire:model="thumbnail_path">
                                <div class="flex justify-end space-x-1">
                                    <button wire:click="excluirThumb()" type="button"
                        ...
                        @else
                            ...
                            @endif
                        @endif
                        <div class="{{ $thumbnail_path ? 'hidden' : ($thumbnail ? 'hidden' : 'col-span-full') }}">
        ...
        <div class="flex grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
            <div class="flex col-span-full items-center space-x-4 mt-10 justify-end">
                <button class="btn btn-success" wire:click="updateContinue()">Salvar e continuar</button>
                <button class="btn btn-neutral" wire:click="update()">Salvar e sair</button>
            </div>
        </div>
    </section>
</div>
